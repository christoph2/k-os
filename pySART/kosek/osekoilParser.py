# $ANTLR 3.4 osekoil.g 2012-08-29 14:20:43
    ...
    def file(self, ):
        ...
        try:
            try:
                ...
                # AST Rewrite
                # elements: implementationDefinition, oilVersion, applicationDefinition
                # token labels: 
                # rule labels: retval
                # token list labels: 
                # rule list labels: 
    ...
    def implementationSpec(self, ):
        ...
        try:
            try:
                ...
                # AST Rewrite
                # elements: description, implementationList, object
                # token labels: 
                # rule labels: retval
                # token list labels: 
                # rule list labels: 
        ...
        try:
            try:
                ...
                if alt46 == 1:
                    ...
                    # AST Rewrite
                    # elements: attributeName, description, numberRange, multipleSpecifier, autoSpecifier, 118, defaultNumber
                    # token labels: 
                    # rule labels: retval
                    # token list labels: 
                    # rule list labels: 
                    ...
                    # AST Rewrite
                    # elements: autoSpecifier, attributeName, multipleSpecifier, description, defaultNumber, numberRange, 96
                    # token labels: 
                    # rule labels: retval
                    # token list labels: 
                    # rule list labels: 
                    ...
                    # AST Rewrite
                    # elements: numberRange, multipleSpecifier, autoSpecifier, attributeName, description, 119, defaultNumber
                    # token labels: 
                    # rule labels: retval
                    # token list labels: 
                    # rule list labels: 
                    ...
                    # AST Rewrite
                    # elements: multipleSpecifier, description, numberRange, defaultNumber, 97, attributeName, autoSpecifier
                    # token labels: 
                    # rule labels: retval
                    # token list labels: 
                    # rule list labels: 
                    ...
                    # AST Rewrite
                    # elements: floatRange, autoSpecifier, multipleSpecifier, attributeName, 94, description, defaultFloat
                    # token labels: 
                    # rule labels: retval
                    # token list labels: 
                    # rule list labels: 
                    ...
                    # AST Rewrite
                    # elements: attributeName, 90, multipleSpecifier, enumeration, autoSpecifier, defaultName, description
                    # token labels: 
                    # rule labels: retval
                    # token list labels: 
                    # rule list labels: 
                    ...
                    # AST Rewrite
                    # elements: defaultString, multipleSpecifier, autoSpecifier, description, attributeName, 114
                    # token labels: 
                    # rule labels: retval
                    # token list labels: 
                    # rule list labels: 
                    ...
                    # AST Rewrite
                    # elements: attributeName, defaultBool, boolValues, description, multipleSpecifier, 84, autoSpecifier
                    # token labels: 
                    # rule labels: retval
                    # token list labels: 
                    # rule list labels: 
    ...
    def enumerator(self, ):
        ...
        try:
            try:
                ...
                # AST Rewrite
                # elements: ID, implParameterList, description
                # token labels: 
                # rule labels: retval
                # token list labels: 
                # rule list labels: 
    ...
    def boolValues(self, ):
        ...
        try:
            try:
                ...
                # AST Rewrite
                # elements: 93, tdesc, fdesc, 117, tlist, flist
                # token labels: 
    ...
    def implRefDef(self, ):
        ...
        try:
            try:
                ...
                # AST Rewrite
                # elements: multipleSpecifier, referenceName, description, objectRefType
                # token labels: 
                # rule labels: retval
                # token list labels: 
                # rule list labels: 
    ...
    def objectDefinition(self, ):
        ...
        try:
            try:
                ...
                # AST Rewrite
                # elements: objectName, description, parameterList
                # token labels: 
                # rule labels: retval
                # token list labels: 
                # rule list labels: 
    ...
    def parameter(self, ):
        ...
        try:
            try:
                ...
                # AST Rewrite
                # elements: attributeValue, description, attributeName
                # token labels: 
                # rule labels: retval
                # token list labels: 
                # rule list labels: 
