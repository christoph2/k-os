...
#define UTL_BIT_SET8(val, bit)   ((uint8)((val) |  (uint8)(1u << (bit))))
#define UTL_BIT_RESET8(val, bit) ((uint8)((val) & (uint8)(~(uint8)(1u << (bit)))))
#define UTL_BIT_GET8(val, bit)   (((uint8)(val) >> (bit)) & 0x1u)

#define UTL_BIT_SET16(val, bit)   ((uint16)((val) |  (uint16)(1u << (bit))))
#define UTL_BIT_RESET16(val, bit) ((uint16)((val) & (uint16)(~(uint16)(1u << (bit)))))
