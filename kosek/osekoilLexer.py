# $ANTLR 3.4 osekoil.g 2012-12-28 09:02:34
...
class osekoilLexer(Lexer):
    ...
    def mID(self, ):
        try:
            ...
            # osekoil.g:718:5: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
            # osekoil.g:718:7: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
            pass 
            ...
            # osekoil.g:718:31: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
            while True: #loop1
                alt1 = 2
    ...
    def mFLOAT(self, ):
        try:
            ...
            # osekoil.g:725:5: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )? | '.' ( '0' .. '9' )+ ( EXPONENT )? | ( '0' .. '9' )+ EXPONENT )
            alt9 = 3
            alt9 = self.dfa9.predict(self.input)
            if alt9 == 1:
                # osekoil.g:725:9: ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )?
                pass 
                # osekoil.g:725:9: ( '0' .. '9' )+
                cnt3 = 0
                while True: #loop3
                ...
                # osekoil.g:726:9: '.' ( '0' .. '9' )+ ( EXPONENT )?
                pass 
                self.match(46)

                # osekoil.g:726:13: ( '0' .. '9' )+
                cnt6 = 0
                while True: #loop6
                    alt6 = 2
    ...
    def mLINE_NUMBER(self, ):
        try:
            ...
            # osekoil.g:730:12: ( '#line ' INT ' ' STRING )
            # osekoil.g:731:5: '#line ' INT ' ' STRING
            pass 
            self.match("#line ")
    ...
    def mDECDIGITS(self, ):
        try:
            # osekoil.g:742:4: ( ZERODIGIT POSDIGIT )
            # osekoil.g:742:7: ZERODIGIT POSDIGIT
            pass 
            self.mZERODIGIT()
    ...
    def mPOSDIGIT(self, ):
        try:
            # osekoil.g:777:4: ( '1' | '2' | '3' | '4' | '5' | '6' | '7' | '8' | '9' )
            # osekoil.g:
            pass 
    ...
    def mHEX(self, ):
        try:
            ...
            # osekoil.g:780:5: ( '0' ( 'x' | 'X' ) ( HEX_DIGIT )+ )
            # osekoil.g:780:8: '0' ( 'x' | 'X' ) ( HEX_DIGIT )+
            pass 
            self.match(48)
    ...
    def mCOMMENT(self, ):
        try:
            ...
            if alt15 == 1:
                ...
                # osekoil.g:785:9: '/*' ( options {greedy=false; } : . )* '*/'
                pass 
                self.match("/*")


                # osekoil.g:785:14: ( options {greedy=false; } : . )*
                while True: #loop14
                    alt14 = 2
    ...
    def mSTRING(self, ):
        try:
            ...
            # osekoil.g:798:5: ( '\"' ( ESC_SEQ |~ ( '\\\\' | '\"' ) )* '\"' )
            # osekoil.g:798:8: '\"' ( ESC_SEQ |~ ( '\\\\' | '\"' ) )* '\"'
            pass 
            self.match(34)

            # osekoil.g:798:12: ( ESC_SEQ |~ ( '\\\\' | '\"' ) )*
            while True: #loop16
                alt16 = 3
    ...
    def mEXPONENT(self, ):
        try:
            # osekoil.g:803:10: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
            # osekoil.g:803:12: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
            pass 
    ...
    def mESC_SEQ(self, ):
        try:
            # osekoil.g:812:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC )
            alt19 = 3
    ...
    def mOCTAL_ESC(self, ):
        try:
            # osekoil.g:819:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
            alt20 = 3
    ...
    def mUNICODE_ESC(self, ):
        try:
            # osekoil.g:826:5: ( '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT )
            # osekoil.g:826:9: '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
            pass 
            self.match(92)
